...
var (
	lang_en_US_page = map[string]string{
		// pages/aid
		...
		`LOGIN_VERSION`:          `QM v%s`,
		`LOGIN_DATE_RANGE`:       `%s - %s`,
		...
		// todo: this was MAGIC_FRIEND_DISABLED, a duplicate key!
		`MAGIC_FRIEND_EMPIRE_DISABLED`: `That empire has been locked by Administration for further investigation - you may not cast spells on it.`,
		...
		`SIGNUP_WELCOME_FIRST`:          `Welcome to %1$s!<br />Promisance is a turn-based strategy game in which your goal is to build the most powerful empire by whatever means necessary, whether through diplomacy or war. More information can be found in the game's <a href="?location=pguide">Guide</a>.<br />The first step to running your own empire is to sign up. By creating an empire, you will also be given a user account which you can reuse in later rounds in order to rank amongst the All Time Top Players.<br />When each round ends, the name of your user account will be shown next to your empire in Round History. %2$s`,
		...
		`SIGNUP_RULES_MULTIS`:           `Players are allowed to create a single account and run %1$s at a time.<br />Players may only use their own account and may not share accounts or baby-sit for others.<br />Anyone found abusing multiple accounts to play extra empires will have their empires disabled and may have their accounts closed.<br />If you are uncertain whether or not you are abiding by the rules, please contact a Moderator or Administrator.`,
		`SIGNUP_MULTIS_SINGLE`:          `<b>%s</b> empire`,
		`SIGNUP_MULTIS_PLURAL`:          `up to <b>%s</b> empires`,
		`SIGNUP_HEADER_USE`:             `Acceptable Use`,
		`SIGNUP_RULES_USE`:              `<ul class="al"><li>Pornography and excessive profanity are not allowed - such material may be offensive to other players.</li><li>Discussion of illegal software (e.g. warez) or activity (e.g. hacking other sites) is prohibited.</li><li>Engaging in commercial activity is not allowed - only the site administrators are permitted to post advertisements.</li><li>Real life threats and violation of user privacy are forbidden.</li></ul>Offenders may have their empires disabled, accounts deleted, and potentially their IP addresses permanently banned.`,
		`SIGNUP_HEADER_SUPPORT`:         `Support`,
		`SIGNUP_RULES_SUPPORT`:          `If you have trouble accessing the game, please email the <a href="mailto:%2$s">administrator</a> and include <b>all of the following</b> in your message:<ol class="al"><li>In the message's Subject line, the name of the game in which you are having a problem: "%1$s".</li><li>Your account's username. <b>Never</b> email your password.</li><li>The Name and ID number of all empires involved, as would be seen on the Scores listing.</li><li>A detailed description of the problem you are experiencing.</li></ol>Failure to include <b>all of the above</b> will likely result in your message being <b>ignored and deleted</b>.`,
